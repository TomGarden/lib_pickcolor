 ...
 */
class PickColorDelegate : SeekBar.OnSeekBarChangeListener {
    ...
    var defNegativeClickListener: ((dialogInterface: DialogInterface?, which: Int, flag: Any?) -> Unit)? =
        null
    var defNeutralClickListener: ((dialogInterface: DialogInterface?, which: Int, flag: Any?) -> Unit)? =
        null
    var defPositiveClickListener: ((dialogInterface: DialogInterface?, which: Int, selColorResult: PickColorResult?, flag: Any?) -> Unit)? =
        null

    var negativeClickListener: ((dialogFrag: PickColorDialogFrag, btnNegative: Button, flag: Any?) -> Unit)? =
        null
    ...
    var positiveClickListener: ((dialogFrag: PickColorDialogFrag, btnPositive: Button, flag: Any?) -> Unit)? =
        null
    ...
    val colorCustomLayout: ViewGroup? by lazy {
        ...
        val resultViewGroup = context?.let {
    ...
    val aDialog: AlertDialog by lazy {
        ...
        builder.setNegativeButton(negativeBtnStr) { dialog, which ->
            defNegativeClickListener?.invoke(
                dialog,
                which,
                flag
            )
            ...
            .setNeutralButton(neutralBtnStr) { dialog, which ->
                defNeutralClickListener?.invoke(
                    dialog,
                    which,
                    flag
                )
